...
replace (
	github.com/ethereum/go-ethereum => github.com/ethereum-optimism/op-geth v1.101315.2-rc.1
	github.com/ethereum/go-ethereum v1.12.0 => github.com/ethereum-optimism/op-geth v1.101315.3-rc.1
)
